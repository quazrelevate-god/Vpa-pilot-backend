...
-- Courtesy STT (invitation/greetings voice message transcription)
ALTER TABLE appointment ADD COLUMN IF NOT EXISTS encrypted_transcript TEXT;
ALTER TABLE appointment ADD COLUMN IF NOT EXISTS transcript_status VARCHAR(20);
ALTER TABLE appointment ADD COLUMN IF NOT EXISTS transcript_attempts INTEGER NOT NULL DEFAULT 0;
