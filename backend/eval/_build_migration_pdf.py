"""
Build docs/llm-platform-migration-plan.pdf from the .md sibling.
...
SRC = ROOT / "docs" / "llm-platform-migration-plan.md"
OUT = ROOT / "docs" / "llm-platform-migration-plan.pdf"
...
def add_footer(canvas, doc):
    ...
    text = (
        f"LLM platform migration plan  ·  PA Office backend  ·  "
        f"page {doc.page}"
    )
...
def main() -> None:
    ...
    doc = SimpleDocTemplate(
        ...
        title="LLM platform migration plan",
