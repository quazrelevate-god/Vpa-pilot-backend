...
const DICT: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "trend.title":      "Ticket trend",
    "trend.thisWeek":   "This week",
    "trend.received":   "Received",
    "trend.resolved":   "Resolved",
    "trend.breached":   "SLA breached",

    "category.title":   "Category breakdown",
    "category.total":   "Total",
    "category.empty":   "No tickets yet",
    "category.other":   "Uncategorised",

    "qa.title":         "Quick actions",
    "qa.assign":        "Assign tickets",
    "qa.assignSub":     "Assign tickets to team",
    "qa.bulk":          "Bulk forward",
    "qa.bulkSub":       "Forward multiple tickets",
    "qa.sla":           "SLA monitor",
    "qa.slaSub":        "View at-risk tickets",
    "qa.export":        "Export report",
    "qa.exportSub":     "Download tickets report",
  ...
  ta: {
    ...
    "seg.reopened":     "மீண்டும் திறந்தவை",
    ...
    "kpi.ofTotal":      "மொத்தத்தில்",

    "trend.title":      "டிக்கெட் போக்கு",
    "trend.thisWeek":   "இந்த வாரம்",
    "trend.received":   "பெறப்பட்டவை",
    "trend.resolved":   "தீர்க்கப்பட்டவை",
    "trend.breached":   "SLA மீறல்",

    "category.title":   "வகை வாரியான பகுப்பு",
    "category.total":   "மொத்தம்",
    "category.empty":   "இதுவரை டிக்கெட்டுகள் இல்லை",
    "category.other":   "வகைப்படுத்தப்படாதவை",

    "qa.title":         "விரைவு நடவடிக்கைகள்",
    "qa.assign":        "டிக்கெட்டுகளை ஒதுக்கு",
    "qa.assignSub":     "குழுவிற்கு டிக்கெட்டுகளை ஒதுக்கு",
    "qa.bulk":          "மொத்தமாக பரிந்துரை",
    "qa.bulkSub":       "பல டிக்கெட்டுகளை பரிந்துரை",
    "qa.sla":           "SLA கண்காணிப்பு",
    "qa.slaSub":        "ஆபத்தில் உள்ள டிக்கெட்டுகள்",
    "qa.export":        "அறிக்கை பதிவிறக்கம்",
    "qa.exportSub":     "டிக்கெட் அறிக்கையை பதிவிறக்கு",
    ...
    "col.ticket":       "டிக்கெட் ஐடி",
    "col.subject":      "தலைப்பு",
    "col.citizen":      "குடிமகன்",
    "col.category":     "வகை",
    "col.priority":     "முன்னுரிமை",
    "col.status":       "நிலை",
    "col.sla":          "SLA நிலை",
    "col.updated":      "புதுப்பிக்கப்பட்டது",
    "col.progress":     "முன்னேற்றம்",
    "col.createdOn":    "உருவாக்கப்பட்டது",
